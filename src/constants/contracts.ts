export const vincask = {
  address: {
    sepolia: "0x65c7e35448bB15b24Cbfaf3b8Df5E075aD0f8ca1" as `0x${string}`,
...
export const vincaskX = {
  address: {
    sepolia: "0xa7e919082066a6e8700E9E6cfbF22BCeD2aff170" as `0x${string}`,
...
export const usdc = {
  address: {
    ...
    sepolia: "0xa4Eb0D6f240F6F7BA3561Fc2a118B27C4438F7ed" as `0x${string}`,
    goerli: "0x98339D8C260052B7ad81c28c16C0b98420f2B46a" as `0x${string}`,
  },
  abi: [
    {
      inputs: [],
