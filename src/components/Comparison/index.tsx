...
const Comparison = () => {
  ...
  return (
    <section className="grid grid-cols-1 gap-10 lg:grid-cols-3">
      ...
      <div className="relative col-span-2 flex flex-col justify-center gap-6 text-xs lg:text-sm">
        ...
        <div className="relative flex h-8 w-[90%] items-center justify-start rounded bg-neutral">
          ...
          <p className="absolute inset-y-0 -right-10 flex items-center lg:-right-16">
            {isMobile ? "$58.8K" : "$58,800"}
          </p>
        </div>
