  ...
  return (
    <button className="flex cursor-default focus:outline-none">
      <a
        ...
        rel="noreferrer"
        target="_blank"
        className="flex items-center justify-center gap-1 px-4 py-2 transition duration-300 ease-in-out rounded-full cursor-pointer bg-secondary text-secondary-content hover:bg-secondary-focus"
      >
