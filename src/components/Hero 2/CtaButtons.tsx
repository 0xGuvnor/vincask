...
const CtaButtons = () => {
  return (
    <div className="flex flex-col items-center justify-center md:gap-16 md:flex-row">
      ...
      >
        <Link href="/whisky" className="flex items-center gap-2 h-[52px]">
          ...
          <span className="absolute inset-x-0 bottom-2.5 w-full h-0.5 transition duration-300 ease-in-out origin-left scale-0 bg-primary group-hover:scale-100"></span>
        </Link>
      </button>
    </div>
  );
