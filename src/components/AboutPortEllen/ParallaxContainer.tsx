...
const ParallaxContainer = ({ parallexImages }: Props) => {
  return (
    <section className="flex flex-col gap-10 overflow-x-clip md:gap-64">
      <ParallexItem
        years={"1825"}
        imageSrc={parallexImages[0]}
      ...
      <ParallexItem
        ...
        imageSrc={parallexImages[5]}
        description="As time progressed, Port Ellen's whiskies not only retained but grew in value and acclaim, symbolizing a pinnacle of whisky craftsmanship. The distillery, slated to reopen in 2024, is poised to create a new chapter in its illustrious history, blending tradition with contemporary whisky-making."
        odd
      />
    </section>
  );
