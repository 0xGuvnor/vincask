...
const Testimony = () => {
  return (
    <div className="flex-1 max-w-4xl px-12 md:ml-20 md:px-0">
      ...
      <div className="relative flex flex-col mt-6 md:mt-16">
        <VscQuote className="absolute -left-10 -top-4 md:-left-[69px] md:-top-11 w-10 h-10 md:h-[69px] md:w-[69px]" />
