  ...
  return (
    ...
    >
      <Image
        ...
        } object-cover object-center transition delay-100 duration-300 ease-in-out group-hover:scale-100 group-hover:blur-md group-hover:brightness-50 group-hover:grayscale`}
      />
